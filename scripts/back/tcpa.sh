...
curl -o /tmp/tcpa_packets_180619_1151.tar.gz http://down.08mb.com/tcp_opz/tcpa/tcpa_packets_180619_1151.tar.gz
...
rpm -ivh http://down.08mb.com/tcp_opz/tcpa/kernel-3.10.0-693.5.2.tcpa06.tl2.x86_64.rpm --force
